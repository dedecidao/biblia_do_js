...
); // Armazena no array chuvasNoNorte os elementos com a propriedade inclinação maior ou igual a 0

const chuvasNoSul = chuvaDeMeteoros.filter(
    (chuva) => chuva.declinacao < 0
); // Armazena no array chuvasNoSul os elementos com a propriedade inclinação menor do que 0


//output  //Um iteravel de cada vez ate acabar todos os iteraveis
