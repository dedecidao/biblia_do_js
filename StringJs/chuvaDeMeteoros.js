const chuvas_meteoros = [
    { nome: "Alfa Centaurídeos", pico: "Fev 8", velocidade: "56 km/s" }, // 0 Indexed Collection
...
for (const chuva of chuvas_meteoros) {
    //Guardando as Propriedades dos objetos na variavel que está sendo iterada
    ...
    switch (pico_mes) { //De acordo com a abreviação que passou pelo metodo split ela joga isso em um case Switch e Tira da Abreviatura armazenada ainda a variavel dentro do loop
    ...
    console.log("Velocidade: ".padEnd(30, ".") + velocidade_formatada);  //Adicionada na saida o metodo nativo PadEnd para formatação apos Nome, Pico e Velocidade.
    console.log("\n");
